  ...
  return (
    <>
      ...
      <ActionForm action={createProductAction} submitLabel="Create draft product" pendingLabel="Creating…" id="create-product-form" label="Create product">
        ...
        <Select name="categoryId" label="Category" options={categories.filter(c => !c.parent_id).map(c => ({ value: c.id, label: label(c) }))} />
        ...
        <Field name="price" label="Price (₹, tax-inclusive)" autoComplete="off" hint="Rupees with up to 2 decimals." />
